...
exports.createExchange = (state, callback) => {
  crypto.keys.generateEphemeralKeyPair(state.protocols.local.curveT, (err, res) => {
    log('2. exchange – generateEphemeralKeyPair done, err', err, 'res', res)
    ...
    log('2. exchange – shared generate set')
    ...
    log('2. exchange – corpus gathered, will sign')

    log('sign()', state.key.local.sign)
